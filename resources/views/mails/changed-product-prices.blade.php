                ...
                <tr>
                    <td class="wrapper" style="font-family: sans-serif;font-size: 14px;vertical-align: top;-webkit-box-sizing: border-box;box-sizing: border-box;padding: 0;">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="header" style="border-collapse: separate;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;border-bottom: 1px solid #3C3C3B;padding-bottom: 20px;">
                            <tr>
                                <td style="font-family: sans-serif;font-size: 14px;vertical-align: top;"><a href="{{route('main')}}" style="width: 90px;display: block;color: #FFAE00;text-decoration: none;"><img src="{{asset('assets/img/logo.svg')}}" alt="logo" width="90" style="display: block;border: none;max-width: 100%;-ms-interpolation-mode: bicubic;"></a></td>
                                        ...
                                        <tr>
                                            <td class="product-img" style="font-family: sans-serif;font-size: 14px;vertical-align: top;width: 54%;">
                                                @if($product->images->isNotEmpty())
                                                    <img src="{{\Storage::disk('public')->url($product->images[0]->url)}}"  alt="product" width="262" height="200" style="border: none;-ms-interpolation-mode: bicubic;max-width: 100%;width: 262px;display: block;" />
                                                @else
                                                    <img src="{{fallbackBaseImageUrl('')}}" alt="product" width="262" height="200" style="border: none;-ms-interpolation-mode: bicubic;max-width: 100%;width: 262px;display: block;" />
                                                @endif
                                            </td>
