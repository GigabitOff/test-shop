<div>
    {{-- In work, do what you enjoy. --}}
          <h4 class="text-center text-xl-start">Кешбэк</h4>
              ...
              <div class="action-group">
                ...
                <div class="action-group-drop">
                  <ul class="action-group-list">
                    <li><a class="ico_plus" href="{{route('admin.bonus.cashback.create')}}"></a></li>
          ...
          <table class="js-table table-td-small table-cashback footable footable-1 footable-paging footable-paging-right breakpoint-lg" data-paging-size="7" style="">
            <thead>
            ...
            <tr>
              <td class="footable-first-visible" style="display: table-cell;">
                  <div class="d-flex align-items-center"><label class="check"><input class="check__input" type="checkbox"><span class="check__box"></span></label><a href="{{route('admin.bonus.cashback.edit',['1'])}}">Спецобувь с нескользящей подошве от Portwest</a></div>
                </td><td class="text-md-center" style="display: table-cell;">29.09.22</td><td class="text-md-center" style="display: table-cell;">29.09.22</td><td style="display: table-cell;"><span class="nowrap">% от любой суммы</span></td><td class="text-center" style="display: table-cell;"><label class="check eye"><input class="check__input" type="checkbox"><span class="check__box"></span></label></td><td class="text-end text-xl-center w-1 footable-last-visible" style="display: table-cell;"><a class="button button-small button-icon ico_edit" href="{{route('admin.bonus.cashback.edit',['1'])}}"></a></td></tr><tr>
              <td class="footable-first-visible" style="display: table-cell;">
                  <div class="d-flex align-items-center"><label class="check"><input class="check__input" type="checkbox"><span class="check__box"></span></label><a href="{{route('admin.bonus.cashback.edit',['1'])}}">Спецобувь с нескользящей подошве от Portwest</a></div>
                </td><td class="text-md-center" style="display: table-cell;">29.09.22</td><td class="text-md-center" style="display: table-cell;">29.09.22</td><td style="display: table-cell;"><span class="nowrap">% от определенной суммы</span></td><td class="text-center" style="display: table-cell;"><label class="check eye"><input class="check__input" type="checkbox"><span class="check__box"></span></label></td><td class="text-end text-xl-center w-1 footable-last-visible" style="display: table-cell;"><a class="button button-small button-icon ico_edit" href="{{route('admin.bonus.cashback.edit',['1'])}}"></a></td></tr><tr>
              <td class="footable-first-visible" style="display: table-cell;">
                  <div class="d-flex align-items-center"><label class="check"><input class="check__input" type="checkbox"><span class="check__box"></span></label><a href="{{route('admin.bonus.cashback.edit',['1'])}}">Спецобувь с нескользящей подошве от Portwest</a></div>
                </td><td class="text-md-center" style="display: table-cell;">29.09.22</td><td class="text-md-center" style="display: table-cell;">29.09.22</td><td style="display: table-cell;"><span class="nowrap">% от любой суммы</span></td><td class="text-center" style="display: table-cell;"><label class="check eye"><input class="check__input" type="checkbox"><span class="check__box"></span></label></td><td class="text-end text-xl-center w-1 footable-last-visible" style="display: table-cell;"><a class="button button-small button-icon ico_edit" href="{{route('admin.bonus.cashback.edit',['1'])}}"></a></td></tr><tr>
              <td class="footable-first-visible" style="display: table-cell;">
