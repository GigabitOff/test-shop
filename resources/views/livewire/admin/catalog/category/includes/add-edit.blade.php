...
<div class="tab-content" id="nav-tabContent">
    <div class="card card-primary tab-pane fade @if('main'=== $show_lang) show active @endif" id="nav-main" role="tabpanel" aria-labelledby="nav-main-tab">
        ...
        <input type="text" class="form-control @error('data.{{ app()->currentLocale() }}.name') is-invalid @enderror" id="pageTitle{{app()->currentLocale() }}" placeholder="@lang('custom::admin.Name')"  wire:model="data.{{ app()->currentLocale() }}.name">
        </div>
        ...
        <div class="form-group" wire:ignore>
            <label>@lang('custom::admin.On Main')</label>
            <span onclick="@this.changeStatusAll('on_main');">
                <input type="checkbox" wire:model="data.on_main" checked data-toggle="toggle" data-on="Так" data-off="Ні" data-size="sm">
            </span>
        </div>
        <div class="form-group" wire:ignore>
