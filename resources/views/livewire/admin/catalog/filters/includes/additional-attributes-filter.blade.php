    ...
    @if($data_paginate AND count($data_paginate)>0)
        ...
        <tr>
            ...
            <td style="display: table-cell;" class="text-center w-1">
                ...
                <input class="form-control form-xs" type="text" placeholder="@lang('custom::admin.Order')" value="{{$item_f['order']}}" onchange="changeOrderCustomAdditional('{{$item_f['id']}}','order',this.value,this);">
                @endif
            </td>
            <td style="display: table-cell;">
                @if($item_f['column_product'] != 'price_init')
...
{{--
<table class="js-table js-table_new filter-base-attr-table footable" data-paging="false">
    <thead>
        <tr>
            <th class="footable-first-visible" style="display: table-cell;">@lang('custom::admin.Name attribute')</th>
            <th  style="display: table-cell;">@lang('custom::admin.Status')</th>
            <th style="display: table-cell;" data-breakpoints="xs">@lang('custom::admin.Display type')</th>
            <th style="display: table-cell;" data-breakpoints="xs">@lang('custom::admin.Collapsed')</th>
            <th style="display: table-cell;" cdata-breakpoints="xs sm md">@lang('custom::admin.Order type')</th>
            <th style="display: table-cell;" class="footable-last-visible text-xl-center w-1" data-breakpoints="xs sm md"></th>
            </tr>
    </thead>
        ...
        <tr>
                ...
                <td style="display: table-cell;">
                    <label class="check --radio" >
                        <input onclick="changeStatusHtml('additional_st_{{$item_f['id']}}',{{$item_f['status']}},'additional_st_val_{{$item_f['id']}}'); @this.changeSingleItem({{$item_f['id']}}, 'status', {{ $item_f['status'] == 1 ? 0 : 1}})" class="check__input" id="additional_st_val_{{$item_f['id']}}" value="{{$item_f['status']}}" type="checkbox" @if($item_f['status'] == 1)checked="checked" @endif
                         /><span class="check__box nowrap" id="additional_st_{{$item_f['id']}}">@if($item_f['status'] == 1)@lang('custom::admin.Included')@else @lang('custom::admin.Offcluded')@endif</span>
                </td>
                ...
                <label class="check --radio">
                        <input class="check__input" type="checkbox"
                         onclick="changeStatusHtml('additional_collapsed_{{$item_f['id']}}',{{$item_f['collapsed']}},'additional_collapsed_val_{{$item_f['id']}}');@this.changeSingleItem({{$item_f['id']}}, 'collapsed', {{ $item_f['collapsed'] == 1 ? 0 : 1}})"
                        value="{{$item_f['collapsed']}}" id="additional_collapsed_val_{{$item_f['id']}}" @if($item_f['collapsed'] == 1)checked="checked" @endif
                         /><span class="check__box nowrap" id="additional_collapsed_{{$item_f['id']}}">@if($item_f['collapsed'] == 1)@lang('custom::admin.Included')@else @lang('custom::admin.Offcluded')@endif</span></td>
                ...
                <td style="display: table-cell;" class="footable-last-visible text-end text-xl-center w-1">
                <input class="form-control form-xs" type="text" placeholder="@lang('custom::admin.Order')" value="{{$item_f['order']}}" onchange="changeItemValue('{{$item_f['id']}}','order',this.value);">
                </td>
              </tr>
        @endforeach
               @else
