<div >
    ...
    {{-- vacancies edit livewire -- Акціїї редагування --}}
@include('livewire.admin.includes.head_button',['type'=>'return', 'route'=>'admin.vacancies.index'])
    <h4>@lang('custom::admin.Jobs') / {{ isset($data[session('lang')]['title']) ? $data[session('lang')]['title'] : ''}}</h4>
...
@livewire('admin.partials.header-livewire', key(time().'header-livewire'))
    ...
    <div class="product-info tab-content mt-4">
        ...
        <div >
            ...
            @include('livewire.admin.vacancies.includes.add-edit-single',['hide_seo'=>true])
        </div>
        </div>
