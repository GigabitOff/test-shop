 <div class="modal fade" id="m-add-edit-founder" tabindex="-1" aria-hidden="true" wire:ignore.self>
    ...
    <div class="form-group">
        <div class="mt-4">
            <div class="person-box__body is-active " style="display: block;" >
                ...
                <button class="button w-100" type="button" @if($item_id) data-bs-dismiss="modal" aria-label="Close" @else onclick="@this.addRemoveFounder()"  @endif >@lang('custom::admin.Save')</button>
                        </div>
            @endif
                        </div>
