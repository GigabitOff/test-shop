...
<div class="tab-content" id="nav-tabContent">
    <div class="card card-primary tab-pane fade @if('main'=== $show_lang) show active @endif" id="nav-main" role="tabpanel" aria-labelledby="nav-main-tab">
        ...
        <input type="text" class="form-control @error('data.link') is-invalid @enderror" id="dataLink" placeholder="@lang('custom::admin.Link')"  wire:model="data.link">
        </div>
        @if($select_pages)
    ...
    <div class="tab-pane fade @if($key===$show_lang) show active @endif" id="nav-{{$item_lang->lang}}" role="tabpanel" aria-labelledby="nav-{{$item_lang->lang}}-tab">
        ...
        <input type="text" class="form-control @error('data.'.$item_lang->lang.'.url') is-invalid @enderror" id="dataLink" placeholder="@lang('custom::admin.Link')"  wire:model="data.{{$item_lang->lang}}.url">
        </div>
