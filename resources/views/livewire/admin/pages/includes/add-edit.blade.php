    ...
    <div class="card card-primary tab-pane fade @if('main'=== $show_lang) show active @endif" id="nav-0" role="tabpanel" aria-labelledby="nav-0-tab">
        <div class="card-body col-9">
            ...
            <div class="form-group row">
                <label for="forParentPage" class="col-sm-3 col-form-label">Приналежність до меню: </label>
                <div class="col-sm-9">
                    <select class="form-control" id="forParentPage" wire:model="menu_select_id">
                    <option value="0">обрати</option>
                    @foreach ($menu_select as $k_menu=>$item)
                    <option value="{{ $k_menu }}" @if($item->page_id==$item->id) selected
