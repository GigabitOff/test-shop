<div  class="container-large">
    @include('livewire.admin.includes.head_button',['type'=>'return', 'route'=>'admin.news.index'])
    <h4>@lang('custom::admin.News') / {{ isset($data[session('lang')]['title']) ? $data[session('lang')]['title'] : ''}}</h4>
    <div wire:ignore>
    ...
    <div class="product-info tab-content mt-4">
        ...
        <div >
            ...
            @include('livewire.admin.pages.news.includes.add-edit-single',['hide_seo'=>true])
        </div>
        </div>
