            ...
            <div class="action-group-btn"><span class="ico_submenu"></span></div>
                  <div class="action-group-drop">
                    <ul class="action-group-list">
                      <li><a class="button button-accent button-small button-icon ico_plus" href="{{ route('admin.actions.create')}}"></a></li>
        ...
        <thead>
            <tr>
                <th scope="col-6"  style="display: table-cell;" class="footable-first-visible">
                    ...
                    <span>@lang('custom::admin.Name action')</span></div></th>
                <th class="text-md-center"  style="display: table-cell;">@lang('custom::admin.Validity')</th>
                <th class="text-md-center"  style="display: table-cell;">@lang('custom::admin.Show on main')</th>
                <th class="text-md-center"  style="display: table-cell;">@lang('custom::admin.Activity')</th>
                <th class="text-md-center"  style="display: table-cell;" data-breakpoints="xs" style="display: table-cell;">@lang('custom::admin.Order')</th>
            ...
            <tr >
                <td style="display: table-cell;" class="footable-first-visible">
                    <div class="box">
                        ...
                        @endif
                        <a href="{{ route('admin.actions.edit', [$item->id]) }}">@if($item->translate(session('lang'))!==null AND isset($item->translate(session('lang'))->title)){{$item->translate(session('lang'))->title}}@else{{config('app.fallback_locale') }}@endif</a>
                    </div>
                </td>
                ...
                <td  style="display: table-cell;" class="text-md-center">
                    <label class="check eye"><input class="check__input" type="checkbox" onclick="@this.changeStatusData({{$item->id}},'on_main')" @if($item->on_main == 0) checked="checked" @endif /><span class="check__box"></span></label>
                ...
                <td style="display: table-cell;" class="text-md-center" style="display: table-cell;">
                ...
                <td class="text-end w-1 footable-last-visible" style="display: table-cell;">
                      <a class="button button-small button-icon ico_edit" href="{{route('admin.actions.edit',$item->id)}}"></a>
