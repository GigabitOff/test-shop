<div class="lk-page__filters">
    ...
    <div>
        <div class="drop --arrow">
            <spav class="drop-clear"></spav><input class="form-control drop-input" type="text" autocomplete="off" placeholder="Категорія" />
            <div class="drop-box">
                <div class="drop-overflow">
                    <ul class="drop-list">
                        <li class="drop-list-item">Категорія 1</li>
                        <li class="drop-list-item">Категорія 2</li>
                        <li class="drop-list-item">Категорія 3</li>
                        <li class="drop-list-item">Категорія 4</li>
                        <li class="drop-list-item">Категорія 5</li>
                        <li class="drop-list-item">Категорія 6</li>
                        <li class="drop-list-item">Категорія 7</li>
                        <li class="drop-list-item">Категорія 8</li>
                        <li class="drop-list-item">Категорія 9</li>
                        <li class="drop-list-item">Категорія 10</li>
                    </ul>
                </div>
            </div>
        </div>
