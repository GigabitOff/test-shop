        ...
        <tr>
            <td>
                <div data-label="№ / @lang('custom::site.date')">
                    <a class="cell-number" href="{{route('manager.orders.show', $order->id)}}">№ {{$order->id}}</a>
            ...
            <td>
                <div data-label="@lang('custom::site.delvery')"><img src="/assets/img/{{$order->deliveryIcon}}"
                                                                     alt="image"></div>
            </td>
                        ...
                        <div class="table-inner__row">
                            <div class="table-inner__cell">
                                <div>
                                    ...
                                    <span
                                        class="cell-date">@lang('custom::site.from') {{formatDate($document->date_at)}}</span>
                                </div>
                            </div>
                            <div class="table-inner__cell">
