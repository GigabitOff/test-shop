...
return [
    ...
    'boolean'              => 'O campo debe ser verdadeiro ou falso.',
    'confirmed'            => 'A confirmación de non coincide.',
    ...
    'dimensions'           => 'As dimensións da imaxe no son válidas.',
    'distinct'             => 'O campo contén un valor duplicado.',
    ...
    'filled'               => 'O campo debe ter un valor.',
    'gt'                   => [
    ...
    'in_array'             => 'O campo non existe en :other.',
    ...
    'multiple_of'          => 'O debe ser un múltiplo de :value',
    'not_in'               => ':attribute seleccionado non é válido.',
    'not_regex'            => 'O formato de non é válido.',
    'numeric'              => ':attribute debe ser un número.',
    'password'             => 'O contrasinal é incorrecto.',
    'present'              => 'O campo debe estar presente.',
    'prohibited'           => 'O campo está prohibida.',
    'prohibited_if'        => 'O campo está prohibida cando :other é :value.',
    'prohibited_unless'    => 'O campo está prohibido, a menos que :other é en :values.',
    'prohibits'            => 'The field prohibits :other from being present.',
    'regex'                => 'O formato de non é válido.',
    'required'             => 'O campo é obrigatorio.',
    'required_array_keys'  => 'The field must contain entries for: :values.',
    'required_if'          => 'O campo é obrigatorio cando :other é :value.',
    'required_unless'      => 'O campo é obrigatorio excepto que :other estea en :values.',
    'required_with'        => 'O campo é obrigatorio cando :values está presente.',
    'required_with_all'    => 'O campo é obrigatorio cando :values están presentes.',
    'required_without'     => 'O campo é obrigatorio cando :values non está presente.',
    'required_without_all' => 'O campo é obrigatorio cando ningún de :values están presentes.',
