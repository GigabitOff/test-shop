...
return [
    ...
    'not_regex'            => 'Formati i është i pasaktë.',
    'numeric'              => ':attribute duhet të jetë një numër.',
    'password'             => 'Fjalëkalimi është i pasaktë.',
    'present'              => ':attribute duhet të jetë prezent/e.',
    'prohibited'           => 'Fusha është e ndaluar.',
    'prohibited_if'        => 'Fusha është e ndaluar kur :other është :value.',
    'prohibited_unless'    => 'Fusha është e ndaluar nëse :other është në :values.',
    'prohibits'            => 'The field prohibits :other from being present.',
    'regex'                => 'Formati i është i pasaktë.',
    'required'             => 'Fusha është e kërkuar.',
    'required_array_keys'  => 'The field must contain entries for: :values.',
    'required_if'          => 'Fusha është e kërkuar kur :other është :value.',
    'required_unless'      => 'Fusha është e kërkuar përveç kur :other është në :values.',
    'required_with'        => 'Fusha është e kërkuar kur :values ekziston.',
    'required_with_all'    => 'Fusha është e kërkuar kur :values ekziston.',
    'required_without'     => 'Fusha është e kërkuar kur :values nuk ekziston.',
    'required_without_all' => 'Fusha është e kërkuar kur nuk ekziston asnjë nga :values.',
