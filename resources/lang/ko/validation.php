...
return [
    ...
    'declined_if'          => ':other이(가) :value일때은(는) 거부되어야 합니다.',
    ...
    'required_if'          => ':other이(가) :value 일 때 필드는 필수입니다.',
    'required_unless'      => ':other이(가) :values에 없다면 필드는 필수입니다.',
    'required_with'        => ':values이(가) 있는 경우 필드는 필수입니다.',
    'required_with_all'    => ':values이(가) 모두 있는 경우 필드는 필수입니다.',
    'required_without'     => ':values이(가) 없는 경우 필드는 필수입니다.',
    'required_without_all' => ':values이(가) 모두 없는 경우 필드는 필수입니다.',
