...
return [
    ...
    'after_or_equal'       => 'اس ہونا ضروری ہے ، ایک تاریخ کے بعد یا اس کے برابر :date.',
    ...
    'before_or_equal'      => 'اس ہونا ضروری ہے ایک تاریخ سے پہلے یا اس کے برابر :date.',
    'between'              => [
    ...
    'date_equals'          => 'اس ہونا ضروری ہے ، ایک تاریخ کے لئے برابر :date.',
    ...
    'dimensions'           => 'اس کے ہے باطل کی تصویر کے طول و عرض.',
    'distinct'             => ':attribute کی دہری ویلیو ہے۔',
    'email'                => ':attribute لازماً قابلِ قبول ای میل ہو۔',
    'ends_with'            => 'اس ختم کرنا ضروری ہے کے ساتھ مندرجہ ذیل میں سے ایک: :values.',
    'enum'                 => 'The selected is invalid.',
    'exists'               => 'منتخب درست نہیں ہے۔',
    'file'                 => 'اس ہونا ضروری ہے ایک فائل.',
    ...
    'ipv4'                 => 'اس ہونا ضروری ہے ایک درست IPv4 ایڈریس.',
    'ipv6'                 => 'اس ہونا ضروری ہے ایک درست IPv6 ایڈریس.',
    ...
    'mimetypes'            => 'اس ہونا ضروری ہے ایک فائل کی قسم: :values.',
    'min'                  => [
    ...
    'multiple_of'          => 'اس ہونا ضروری ہے ایک سے زیادہ کے :value',
    'not_in'               => 'منتخب قابلِ قبول نہیں ہے۔',
    'not_regex'            => 'اس شکل باطل ہے.',
    'numeric'              => ':attribute لازماً کوئی عدد ہو۔',
    'password'             => 'پاس ورڈ غلط ہے.',
    'present'              => ':attribute فیلڈ موجود ہونا ضروری ہے۔',
    'prohibited'           => 'اس میدان ممنوع ہے.',
    ...
    'required_unless'      => 'جب تک :other :values میں نہ ہو تو فیلڈ درکار ہے۔',
    ...
    'uploaded'             => 'اس ناکام اپ لوڈ کرنے کے لئے.',
    'url'                  => ':attribute فارمیٹ قابلِ قبول نہیں ہے۔',
    'uuid'                 => 'اس ہونا ضروری ہے ایک درست UUID.',
    'custom'               => [
        'attribute-name' => [
