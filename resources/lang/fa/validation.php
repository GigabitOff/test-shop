...
return [
    ...
    'boolean'              => 'فیلد فقط می‌تواند true و یا false باشد.',
    ...
    'dimensions'           => 'ابعاد تصویر قابل قبول نیست.',
    'distinct'             => 'فیلد مقدار تکراری دارد.',
    'email'                => ':attribute باید یک ایمیل معتبر باشد.',
    'ends_with'            => 'فیلد باید با یکی از مقادیر زیر خاتمه یابد: :values',
    'enum'                 => ':attribute انتخاب شده اشتباه است.',
    'exists'               => ':attribute انتخاب شده، معتبر نیست.',
    'file'                 => ':attribute باید یک فایل معتبر باشد.',
    'filled'               => 'فیلد باید مقدار داشته باشد.',
    'gt'                   => [
    ...
    'not_regex'            => 'فرمت معتبر نیست.',
    'numeric'              => ':attribute باید عدد یا رشته‌ای از اعداد باشد.',
    'password'             => 'رمزعبور اشتباه است.',
    'present'              => 'فیلد باید در پارامترهای ارسالی وجود داشته باشد.',
    'prohibited'           => 'فیلد ممنوع است.',
    'prohibited_if'        => 'فیلد ممنوع است هنگامیکه مقدار :other برابر :value باشد.',
    'prohibited_unless'    => 'فیلد ممنوع است مگر اینکه مقدار :other در :values باشد.',
    'prohibits'            => 'فیلد اجازه حضور فیلد :other را نمی دهد.',
    'regex'                => 'فرمت معتبر نیست.',
    'required'             => 'فیلد الزامی است.',
    'required_array_keys'  => 'فیلد باید حاوی ورودی های :values باشد.',
    'required_if'          => 'هنگامی که :other برابر با :value است، فیلد الزامی است.',
    'required_unless'      => 'فیلد الزامی است، مگر آنکه :other در :values موجود باشد.',
    'required_with'        => 'در صورت وجود فیلد :values، فیلد نیز الزامی است.',
    'required_with_all'    => 'در صورت وجود فیلدهای :values، فیلد نیز الزامی است.',
    'required_without'     => 'در صورت عدم وجود فیلد :values، فیلد الزامی است.',
    'required_without_all' => 'در صورت عدم وجود هر یک از فیلدهای :values، فیلد الزامی است.',
    ...
    'string'               => 'فیلد باید متن باشد.',
    'timezone'             => 'فیلد باید یک منطقه زمانی معتبر باشد.',
    'unique'               => ':attribute قبلا انتخاب شده است.',
    'uploaded'             => 'بارگذاری فایل موفقیت آمیز نبود.',
