...
return [
    ...
    'max'                  => [
        'array'   => 'Jumlah mesti tidak melebihi :max perkara.',
        'file'    => 'Jumlah mesti tidak melebihi :max kilobait.',
        'numeric' => 'Jumlah mesti tidak melebihi :max.',
        'string'  => 'Jumlah mesti tidak melebihi :max aksara.',
    ],
    'mimes'                => ':attribute mesti fail type: :values.',
    'mimetypes'            => ':attribute mesti fail type: :values.',
    'min'                  => [
        'array'   => 'Jumlah mesti sekurang-kurangnya :min perkara.',
        'file'    => 'Jumlah mesti sekurang-kurangnya :min kilobait.',
        'numeric' => 'Jumlah mesti sekurang-kurangnya :min.',
        'string'  => 'Jumlah mesti sekurang-kurangnya :min aksara.',
    ],
    'multiple_of'          => ':attribute mesti gandaan :value',
    'not_in'               => ':attribute tidak sah.',
    'not_regex'            => 'Format adalah tidak sah.',
    'numeric'              => ':attribute mesti nombor.',
    'password'             => 'Kata laluan tidak sah.',
    'present'              => 'Ruangan mesti wujud.',
    'prohibited'           => 'Ruangan adalah dilarang.',
    'prohibited_if'        => 'Ruangan adalah dilarang apabila :other adalah :value.',
    'prohibited_unless'    => 'Ruangan adalah dilarang kecuali :other adalah di :values.',
    'prohibits'            => 'The field prohibits :other from being present.',
    'regex'                => 'Format tidak sah.',
    'required'             => 'Ruangan diperlukan.',
    'required_array_keys'  => 'The field must contain entries for: :values.',
    'required_if'          => 'Ruangan diperlukan bila :other sama dengan :value.',
    'required_unless'      => 'Ruangan diperlukan sekiranya :other ada dalam :values.',
    'required_with'        => 'Ruangan diperlukan bila :values wujud.',
    'required_with_all'    => 'Ruangan diperlukan bila :values wujud.',
    'required_without'     => 'Ruangan diperlukan bila :values tidak wujud.',
    'required_without_all' => 'Ruangan diperlukan bila kesemua :values wujud.',
    'same'                 => 'Ruangan dan :other mesti sepadan.',
    'size'                 => [
        'array'   => 'Saiz mesti mengandungi :size perkara.',
        'file'    => 'Saiz mesti :size kilobait.',
        'numeric' => 'Saiz mesti :size.',
        'string'  => 'Saiz mesti :size aksara.',
    ],
