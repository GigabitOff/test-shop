...
return [
    ...
    'not_in'               => 'Izbran je neveljaven.',
    'not_regex'            => 'Format je neveljaven.',
    'numeric'              => ':attribute mora biti število.',
    'password'             => 'Greslo ni pravilno.',
    'present'              => 'Polje mora biti prisotno.',
    'prohibited'           => 'Polje je prepovedano.',
    'prohibited_if'        => 'Polje je prepovedano, ko je :other :value.',
    'prohibited_unless'    => 'Polje je prepovedano, razen če je :other v :values.',
    'prohibits'            => 'To polje prepoveduje prisotnost :other.',
    'regex'                => 'Format polja je neveljaven.',
    'required'             => 'Polje je obvezno.',
    'required_array_keys'  => 'The field must contain entries for: :values.',
    'required_if'          => 'Polje je obvezno, če je :other enak :value.',
    'required_unless'      => 'Polje je obvezno, razen če je :other v :values.',
    'required_with'        => 'Polje je obvezno, če je :values prisoten.',
    'required_with_all'    => 'Polje je obvezno, če so :values prisoten.',
    'required_without'     => 'Polje je obvezno, če :values ni prisoten.',
    'required_without_all' => 'Polje je obvezno, če :values niso prisotni.',
    'same'                 => 'Polje in :other se morata ujemati.',
    'size'                 => [
