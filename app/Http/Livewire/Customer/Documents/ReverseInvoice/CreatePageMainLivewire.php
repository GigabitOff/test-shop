...
namespace App\Http\Livewire\Customer\Documents\ReverseInvoice;
...
class CreatePageMainLivewire extends Component
{
    ...
    public function render()
    {
        ...
        $table = view('livewire.customer.documents.reverse-invoice.create-footable-render', [
            'products' => $products,
        ])->render();

        return view(
            'livewire.customer.documents.reverse-invoice.create-page-main-livewire',
            [
                'products' => $products,
                'table' => $table,
                'totals' => $totals,
