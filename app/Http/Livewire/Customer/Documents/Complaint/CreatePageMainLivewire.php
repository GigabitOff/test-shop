...
namespace App\Http\Livewire\Customer\Documents\Complaint;
...
class CreatePageMainLivewire extends Component
{
    ...
    public function render()
    {
        ...
        $table = view('livewire.customer.documents.complaint.create-footable-render', [
            'products' => $products,
        ])->render();

        return view(
            'livewire.customer.documents.complaint.create-page-main-livewire',
            [
                'products' => $products,
                'table' => $table,
                'totals' => $totals,
